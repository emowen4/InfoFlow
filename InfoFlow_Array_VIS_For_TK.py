...
class StateDisplay(tk.Frame):
    ...
    def __init__(self, parent, width, height):
        ...
        self.frame_game = tk.LabelFrame(self.root, text=" Game View ", bg=Style.color_background, fg=Style.color_text, font=Style.get_font("Chiller", Style.font_size_title, bold=True))
...
class MessageDisplayStateRenderer(StateRenderer):
    ...
    def render(self, display: 'StateDisplay', state: 'State', last_state: 'State'):
        ...
        display.canvas_game.create_text(75, 75, text="i", fill=Style.color_text, font=Style.get_font("Impact", 18, bold=True))
